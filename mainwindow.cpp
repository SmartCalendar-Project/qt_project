    ...
    ui(new Ui::MainWindow)
{
    ...
    ui->memo->setStyleSheet("background-color:transparent; border: 0px);");
    ui->tv->setStyleSheet("background-color:transparent; border: 0px);");
...
/*****************************************************/
    ...
    ini.loadData();
        ...
        position->setGeometry(80,460,481,10);


        volumeControl   = new QVolumeControl(player, this->ui->page_2);
        volumeControl->setGeometry(530,370,41,81);
